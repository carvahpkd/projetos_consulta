...
select * from TB_ProjectConfiguration
where id in (
select *--projectconfigurationid 
from TB_SupplierIntegrationParameter
where supplierid = 81 and name like 'idCampanha' order by projectconfigurationid)